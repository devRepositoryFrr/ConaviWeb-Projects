    ...
    public class LevantamientoRepository : ILevantamientoRepository
    {
        ...
        public async Task<bool> InsertFormatoLevantamiento(Predio predio)
        {
            ...
            var result = await db.ExecuteAsync(sql, new
            {
                ...
                condicion_vialidad_conexion_predio_nivel = predio.CondicionesVialidadNivel,
                ...
                condicion_acceso_predio_nivel = predio.CondicionesAccesoPredioNivel,
