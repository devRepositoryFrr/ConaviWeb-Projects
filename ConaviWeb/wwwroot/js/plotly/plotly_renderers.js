(function() {
  ...
  callWithJQuery(function($, Plotly) {
    ...
    return $.pivotUtilities.plotly_renderers = {
      "Gráfica de barras horizontal": makePlotlyChart({
        type: 'bar',
        orientation: 'h'
      }, {
        barmode: 'group'
      }, true),
      "Gráfica de barras apiladas horizontal": makePlotlyChart({
        type: 'bar',
        orientation: 'h'
      }, {
        barmode: 'relative'
      }, true),
      "Gráfica de barras": makePlotlyChart({
        type: 'bar'
      }, {
        barmode: 'group'
      }),
      "Gráfica de barras apiladas": makePlotlyChart({
        type: 'bar'
      }, {
        barmode: 'relative'
      }),
      "Gráfica de línea": makePlotlyChart(),
      "Gráfica de dispersión": makePlotlyScatterChart()
    };
  });
