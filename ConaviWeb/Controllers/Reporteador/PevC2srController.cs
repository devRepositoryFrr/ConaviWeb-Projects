...
"2204055221"};
        ...
        public Document GetPDF(Document doc, PevC2sr beneficiario)
        {
            ...
            Paragraph titulo = new Paragraph("CEDULA DEBIDAMENTE REQUISITADA")
            ...
            bloque1.SetFixedPosition(1, 50, 570 , 500);
            ...
            Cell FechaNacimientotxt = new Cell(1, 1)
                ...
                .SetBorder(Border.NO_BORDER)
                .SetFontSize(7)
                .Add(new Paragraph(beneficiario.Fecha_nacimiento));
            Cell generotxt = new Cell(1, 1)
                ...
                .SetBorder(Border.NO_BORDER)
                .SetFontSize(7)
                .Add(new Paragraph(beneficiario.Id_genero));
            ...
            Cell Georeferencia = new Cell(1, 1)
             ...
             .Add(new Paragraph("Localidad"));
              Cell NombreINE = new Cell(1, 1)
                 ...
                 .SetBorder(Border.NO_BORDER)
                 .SetFontSize(7)
                 .Add(new Paragraph(beneficiario.Nombre_ine + " " + beneficiario.Primer_apellido_ine + " " + beneficiario.Segundo_apellido_ine)); 
            ...
            .SetBorder(Border.NO_BORDER)
            .SetFontSize(7)
            .Add(new Paragraph(beneficiario.Nombre_localidad));
           ...
           .Add(new Paragraph("Telefonos de Contacto"));
            ...
            Cell Referenciatxt = new Cell(1, 1)
              ...
              .SetBorder(Border.NO_BORDER)
              .SetFontSize(7)  
              .Add(new Paragraph(beneficiario.Referencia));
            ...
            bloque1a.SetFixedPosition(1, 50, 510, 500);
           ...
           .SetTextAlignment(TextAlignment.CENTER);
            ...
            bloque2.SetFixedPosition(1, 50, 460, 500);
            ...
            bloque3.SetFixedPosition(1, 50, 240, 500);
