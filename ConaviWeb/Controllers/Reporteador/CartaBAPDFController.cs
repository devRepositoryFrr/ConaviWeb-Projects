...
namespace ConaviWeb.Controllers.Reporteador
{
    public class CartaBAPDFController : Controller
    {
        ...
        public CartaBAPDFController(IWebHostEnvironment environment)
        {
        ...
        public void ManipulatePdf()
        {
            ...
            PdfDocument pdfDoc = new PdfDocument(new PdfWriter(Path.Combine(_environment.WebRootPath, "doc", "cartaBA.pdf")));
