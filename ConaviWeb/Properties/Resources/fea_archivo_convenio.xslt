...
<!-- Con el siguiente método se establece que la salida deberá ser en texto -->
  ...
  <xsl:template match="FirmaElectronica">
    |<xsl:apply-templates select="FirmaElectronicaArchivoConveniov1"/>||
  </xsl:template>

  <xsl:template match="FirmaElectronicaArchivoConveniov1">
...
<!-- Iniciamos el tratamiento de los atributos del Emisor -->
  ...
  <xsl:call-template name="Requerido">
    ...
    <xsl:with-param select="formato" name="valor"/>
